...
class Aplication:
    def __init__(self, master=None):
        ...
        #TÍTULO
        self.titulo = Label(self.primeiroContainer, font=('Gotham','18','bold'), text='Calculadora Simples')
        self.titulo['bg'] = '#E6E6FA'
        self.titulo['fg'] = 'black'
        self.titulo.pack()


        self.primeiroNumero = Entry(self.segundoContainer, bd=2)
        ...
        self.segundoNumero = Entry(self.terceiroContainer,bd=2)
        ...
        self.msg['fg'] = 'black'
        self.msg['bg'] = '#E6E6FA'
        self.msg.place(x=80, y=75, width=115)

        self.msg2 = Label(master)
        self.msg2['text'] = 'Insira o 2º valor: '
        self.msg2['fg'] = 'black'
        self.msg2['bg'] = '#E6E6FA'
        self.msg2['font'] = self.fontePadrao
        self.msg2.place(x=80, y=128, width=115)
    ...
    def limpar(self):
        ...
        self.primeiroNumero.delete(0, 'end')
        self.segundoNumero.delete(0, 'end')
